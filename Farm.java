...
/**
 * This class represents a farm and stores its milk weight data and manages users' requests for
 * data.
 */
public class Farm {
  ...
  private class annualData {
    ...
    /**
     * Return the total amount of milk produced by this farm in this month of the year.
     * 
     * @return the total amount of milk produced by this farm in this month of the year
     */
    ...
    /**
     * Return the total amount of milk produced by this farm in this period of time in this year.
     * 
  ...
  /**
   * Calculate the total amount of milk produced in this farm during a certain period. Starting date
   * must be earlier than ending date.
   * 
   ...
   */
  public int[] sumWithinRange(int yStart, int mStart, int dStart, int yEnd, int mEnd, int dEnd) {
    ...
    while (dateToInt(yStart, mStart, dStart) <= dateToInt(yEnd, mEnd, dEnd)) {
      ...
      if (!sameDate(mStart, dStart, 2, 30) && !sameDate(mStart, dStart, 2, 31)
          && !sameDate(mStart, dStart, 4, 31) && !sameDate(mStart, dStart, 6, 31)
          && !sameDate(mStart, dStart, 9, 31) && !sameDate(mStart, dStart, 11, 31)
  ...
  /**
   * Calculate the average amount of milk produced in this farm during a certain period. Starting
   * date must be earlier than ending date.
   * 
   * @param yStart year of starting date
   * @param mStart month of starting date
   * @param dStart day of starting date
   ...
   */
  public double avgWithinRange(int yStart, int mStart, int dStart, int yEnd, int mEnd, int dEnd) {
   ...
   * @return an array of String of length 3 where index 0, 1, 2 are the year, month, day of the date
   *         of next day.
   */
  ...
  /**
   * Calculate the yearly average of milk weight produced by this farm (i.e: [kg/day]).
   * 
  ...
  /**
   * Calculate annual sum of milk weight produced by this farm in the year specified.
   * 
   * @param year target year
