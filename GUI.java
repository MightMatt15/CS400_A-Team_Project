  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    search.setOnAction(event -> {// show weight for that day?
      try {
        ...
        Alert alert =
            new Alert(AlertType.ERROR, "The day, month, and year entered should be a number");
        alert.showAndWait();
      }
    });
    ...
    // ArrayIndexOutOfBoundsException | NumberFormatException | IllegalNullKeyException |
    ...
    maxMonthTF.setOnAction(event -> {
      ...
      try {
        ...
        resultsVBox.getChildren()
            .add(createLabel("January Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("February Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("March Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("April Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("May Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("June Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("July Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("August Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("September Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("October Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("November Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("December Max: " + "", "Times New Roman", FontWeight.BOLD, 15));
      ...
      try {
        ...
        resultsVBox.getChildren()
            .add(createLabel("Results for Minimum Weights for " + minMonthTF.getText(),
                "Chalkduster", FontWeight.BOLD, 20));
        resultsVBox.getChildren()
            .add(createLabel("January Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("February Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("March Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("April Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("May Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("June Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("July Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("August Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("September Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("October Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("November Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("December Min: " + "", "Times New Roman", FontWeight.BOLD, 15));
        panelResults.setCenter(resultsVBox);
        primaryStage.setScene(resultsScene);
        primaryStage.show();
      } catch (ArrayIndexOutOfBoundsException e) {
      ...
      try {
        ...
        resultsVBox.getChildren()
            .add(createLabel("Results for Average Weights for " + avgMonthTF.getText(),
                "Chalkduster", FontWeight.BOLD, 20));
        resultsVBox.getChildren()
            .add(createLabel("January Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("February Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("March Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("April Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("May Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("June Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("July Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("August Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("September Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("October Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("November Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        resultsVBox.getChildren()
            .add(createLabel("December Avg: " + "", "Times New Roman", FontWeight.BOLD, 15));
        panelResults.setCenter(resultsVBox);
        primaryStage.setScene(resultsScene);
        primaryStage.show();
      } catch (ArrayIndexOutOfBoundsException e) {
