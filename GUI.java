...
//              FontWeight.BOLD, 15), 0, 8);
        ...
        TextField farmReportOutput = new TextField("Farm ID,Year,Path e.g. Farm 2,2018,C:\\Test.txt no spaces please, separate with a comma");
...
//              .add(new TextField("Start date, End Date:   year,month,day, month,day"));
        ...
        farmReportOutput.setOnAction(e -> {
          ...
          String newString = farmReportOutput.getText().substring(farmReportOutput.getText().indexOf(",") + 1);
